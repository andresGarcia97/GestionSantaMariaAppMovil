...
export const HORA_MINIMA_SALIDA = 5;
...
export const LUGAR_SALA_INFORMATICA = 'SALA-INFORMATICA';
export const LUGAR_AUDITORIO = 'AUDITORIO';
export const LUGAR_SALON_AMARILLO = 'SALON-AMARILLO';
